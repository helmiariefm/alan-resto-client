    ...
    <div class="px-20 text-black mt-7">
      <div class="w-full p-9 bg-white shadow-lg">
        ...
        <form>
          ...
          <input type="text" class="w-full border-2 border-zinc-300 bg-white px-2 py-1 my-1 rounded-sm"/>
          <br><br>
          <label>Gambar</label>
          <div
          ...
          <div class="text-right mt-2">
            <button class="text-white font-semibold bg-emerald-600 hover:bg-emerald-500 rounded-sm px-2 py-1 w-48">Simpan</button>
          </div>
        </form>
      </div>
    </div>
